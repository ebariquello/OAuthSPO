...
namespace SpOnlineWrapper
{
    ...
    public class XMLMinifierFactory
    {

        public static XMLMinifier GetInstace { get{ return new XMLMinifier(new XMLMinifierSettings() { CloseEmptyTags = false, RemoveComments = true, RemoveEmptyLines = true, RemoveWhitespaceBetweenElements = true }); } }
    }
}